            ...
            fluidRow(
                box(
                    ...
                    column(12, 
                           tags$div(
                               fluidRow(
                                   column(12, tags$span("The following are the research questions for this project, the first one already being answered above with the correlation plot between all the socio-economic indicators and Happiness Score:", style = "font-size:20px"),
                                          br(), 
